...
# **Cloud Native Resource Monitoring Python App on aws EKS!**
...
When you run this command on windows cmd , the AWS CLI will update your Kubernetes configuration file to include the necessary information to connect to your EKS cluster. 
You can then use the kubectl command to interact with your EKS cluster.
